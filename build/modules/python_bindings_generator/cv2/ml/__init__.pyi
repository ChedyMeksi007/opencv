...
class EM(StatModel):
    ...
    @_typing.overload
    def predict2(self, sample: cv2.typing.MatLike, probs: cv2.typing.MatLike | None = ...) -> tuple[cv2.typing.cv::Vec2d, cv2.typing.MatLike]: ...
    @_typing.overload
    def predict2(self, sample: cv2.UMat, probs: cv2.UMat | None = ...) -> tuple[cv2.typing.cv::Vec2d, cv2.UMat]: ...
